...
public class OnlineModeListHelper {
    ...
    private String url = "https://sheltered-ridge-15829.herokuapp.com/displayall";
    ...
    private void parseJSON(String response) {
        ...
        try {
            ...
            JSONArray arrHeadlines = objResponse.getJSONArray("musicList");
...
//                Log.d(TAG, "parseJSON: " +(arrHeadlines.getJSONObject(i).getString("title")));
            ...
            for (int i=0;i<arrHeadlines.length();i++) {
                ...
                audio.setData(obj.getString("url"));
                audio.setSongDuration(Integer.parseInt(obj.getString("duration")));
